...
/**
 *  ComponentResizer by Rob Camick - The ComponentResizer allows you to
 *  resize a component by dragging a border of the component.
 *
 *  Thread: https://stackoverflow.com/a/24476755
...
public class ComponentResizer extends MouseAdapter {
    ...
    /**
     *  Convenience contructor. All borders are resizable in increments of
     *  a single pixel. Components can be registered when the class is
     *  created or they can be registered separately afterwards.
     *
    ...
    /**
     *  Convenience contructor. Eligible borders are resisable in increments
     *  of a single pixel. Components can be registered when the class is
     *  created or they can be registered separately afterwards.
     *
     *  @param dragInsets Insets specifying which borders are eligible to
     *                    be resized.
     *  @param components components to be automatically registered
     */
    ...
    /**
     *  Specify the minimum size for the component. The minimum size
     *  is constrained by the drag insets.
     *
     ...
     */
    private void validateMinimumAndInsets(Dimension minimumSize, Insets dragInsets) {
        int minimumWidth = dragInsets.left + dragInsets.right;
        int minimumHeight = dragInsets.top + dragInsets.bottom;
